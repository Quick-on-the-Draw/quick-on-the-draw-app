  ...
  return (
    <>
      <form className="formBtn" onChange={handleTimeChange}>
        <h1 className="text-lg">Timer Duration:</h1>
        <input className="radio" id="1" type="radio" name="time" value="1" />
        ...
        <input className="radio" id="10" type="radio" name="time" value="10" />
